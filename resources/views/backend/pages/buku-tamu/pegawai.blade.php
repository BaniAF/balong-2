...
@section('content')
                            ...
                            <tr>
                                ...
                                <td class="p-2 m-1">
                                    <div class="d-flex m-auto mb-0">
                                        <div>
                                            <img src="{{ asset('uploads/Pegawai/' . $dataPegawai->fotoPegawai) }}"
                                                alt="Foto Pegawai" class="avatar avatar-md me-2 w-auto"
                                                style="border-radius: 10px" data-bs-toggle="modal"
                                                data-bs-target="#imagePreviewModal"
                                                data-image-src="{{ asset('uploads/Pegawai/' . $dataPegawai->fotoPegawai) }}">
                                        </div>
                                ...
                                <td class="text-center aligns-item-center">
                                    <div
                                        ...
                                        <button id="btnEditPegawai"
                                            ...
                                            data-id="{{ $dataPegawai->id }}" data-nip="{{ $dataPegawai->nip }}"
    ...
    <div class="modal fade" id="backDropModal" data-bs-backdrop="static" tabindex="-1">
        <div class="modal-dialog">
            <form class="modal-content" enctype="multipart/form-data" method="post" action="{{ route('tambah-pegawai') }}"
                id="formTambah">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            ...
                            <input type="text" name="nip" id="nip" class="form-control border"
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            ...
                            <select name="jabatan" id="jabatan" class="form-control" onchange="showBidangOptions()">
                                ...
                                <option value="Kasi Pembangunan dan Pemberdayaan Masyarakat">Kasi Pembangunan dan
                                    Pemberdayaan Masyarakat</option>
                                <option value="Anggota">Staff</option>
                ...
                <div class="modal-footer d-flex">
                    ...
                    <button type="button" class="btn btn-primary mb-0" name="submitType" value="simpan"
                        onclick="saveData()">Simpan</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal fade" id="modalEdit" data-bs-backdrop="static" tabindex="-1">
        <div class="modal-dialog">
            <form class="modal-content" enctype="multipart/form-data" method="post"
                action="{{ route('tambah-pegawai') }}" id="formEdit">
                @csrf
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <label for="nameBackdrop" class="form-label">NIP Pegawai</label>
                            <input type="text" name="nip" id="nip" class="form-control border"
                                placeholder="Contoh : 2131730052" readonly />
                            <span class="error-message text-danger" id="nip-error"></span>
                        </div>
                        <div class="col-md-6 mb-2">
                            <label for="nameBackdrop" class="form-label">Nama Pegawai</label>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#modalEdit').on('show.bs.modal', function(event) {
                ...
                if (foto) {
                    var imageUrl = 'uploads/Pegawai/' +
                        foto; // Assuming the base URL for uploads is 'uploads'
